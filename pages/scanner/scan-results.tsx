...
const ScanResultsPage: React.FC = () => {
  ...
  <>
    <button
      ...
      className="mt-4 px-6 py-2 bg-green-500 hover:bg-green-600 text-white font-semibold rounded shadow"
    >
      Generate Summary
    </button>
    ...
    <button
      ...
      className="mt-4 ml-4 px-6 py-2 bg-indigo-500 hover:bg-indigo-600 text-white font-semibold rounded shadow"
    >
      View Summary
    </button>
  </>
...
//           `${API_URL}/api/scan-results/${scanId}`,
//           {
//             headers: {
//               Authorization: `Bearer ${token}`,
//             },
